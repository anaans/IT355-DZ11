...
<body>
 	...
 	<div class="container">
	<div class="well lead">Stranica za porucivanje</div>
 	<form:form method="POST" modelAttribute="order" class="form-horizontal">
		<div class="row">
			<div class="form-group col-md-12">
				<label class="col-md-3 control-lable" for="productName">Naziv</label>
				<div class="col-md-7">
		...
		<div class="row">
			<div class="form-actions floatRight">
				<input type="submit" value="Poruci" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/home' />">Cancel</a>
			</div>
		</div>
	</form:form>
	</div>
